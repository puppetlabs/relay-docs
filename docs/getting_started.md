...
> Fruther reading: [Types reference](reference/relay-types.md), [Complex "Sock Shop" workflow](https://github.com/puppetlabs/nebula-workflow-examples/tree/master/example-workflows/aks-sock-shop).
